...
const Language: React.FC = () => {
  return(
    <form.MainLayout>
      ...
      <form.TopLayout>
        <form.Title>Include the languages you speak to enrich your profile</form.Title>
        <form.Description>This can enhance your competitiveness in the job market, broaden your career opportunities, and demonstrate your cultural awareness and adaptability.</form.Description>
      </form.TopLayout>
      
      <div className="  flex ml-[18.5rem]  mx-auto">
        <div className="w-full mt-7 max-w-3xl">
          <form className="  rounded  pt-4 pb-2 mb-4">
            <form.AddInputText className="w-[100%]" placeholder="e.g.  English">Language</form.AddInputText>
          </form>
        </div>
      </div>
      <form.addListButton className="text-sm">Add Langugage</form.addListButton>
    </form.MainLayout>
  )
}
