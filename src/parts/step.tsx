...
const StepSection: React.FC = () => {
  return (
    <>
      <div
        className={` max-w-5xl flex flex-col sm:flex-row  mx-auto  lg:px-0 pt-3 justify-center items-center `}
      >
        <CustomCard
          img={choose}
          title="Step 1"
          contentClassName="pb-16  mx-auto"
          content="Select one of the templates we offer."
        />
        <img src={strip} className="mt-[-190px]" alt="" />
        <CustomCard
          img={input}
          title="Step 2"
          contentClassName="pb-16  mx-auto"
